...
const STRATEGIES_SCHEMA: Record<string, FieldDef> = {
  ...
  "signal_strategy.execution_policy.default": { type: "enum", enum: ["enabled", "observe_only", "disabled"] },
  "signal_strategy.execution_policy.signals.buy_1": { type: "enum", enum: ["enabled", "observe_only", "disabled"] },
  "signal_strategy.execution_policy.signals.buy_2": { type: "enum", enum: ["enabled", "observe_only", "disabled"] },
  "signal_strategy.execution_policy.signals.buy_3": { type: "enum", enum: ["enabled", "observe_only", "disabled"] },
  "signal_strategy.execution_policy.signals.macd_golden_cross_pullback_confirmed_above": { type: "enum", enum: ["enabled", "observe_only", "disabled"] },
  "signal_strategy.execution_policy.signals.macd_golden_cross_pullback_confirmed_near": { type: "enum", enum: ["enabled", "observe_only", "disabled"] },
